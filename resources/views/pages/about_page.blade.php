...
<head>
    ...
    <link rel="icon" href="img/logo bel.png" type="image/x-icon">
...
<body>
    ...
    <div class="page-wrapper">
     ...
     @include('header')
        ...
        <!-- Page Title -->
        <section class="page-title" style="background-image: url(img/cover55.jpg);">
            ...
            <div class="top-content">
                <div class="auto-container">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="experience-year">
                                ...
                                <div class="content">
                                    ...
                                    <h5>input information about company he</h5>
                                </div>
                        ...
                        <div class="col-lg-8">
                            <div class="image mb-30"><img src="img/belcom.jpg" class="image" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="author-info wow fadeInUp" data-wow-duration="1500ms">
                                    ...
                                    <div>
                                        <div class="author-title">  {{$data3->ceo}} </div>
        ...
        <section class="statement-section pt-0">
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="image"><img src="img/cover55.jpg" class='image' alt=""></div>
                    </div>
                    <div class="col-lg-6">
                        <div class="content">
                            <div class="badge"><img src="img/logo bel.png" alt=""></div>
                            <!-- Tab panes -->
                            <div class="tab-content wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                                ...
                                <div class="tab-pane fadeInUp animated" id="tab-two" role="tabpanel" aria-labelledby="tab-two">
                                    <div class="text-block">
                                        ...
                                        <div class="text"> {{$data3->info_version}}</div>
                                    </div>
                                </div>
                                <div class="tab-pane fadeInUp animated" id="tab-three" role="tabpanel" aria-labelledby="tab-three">
                                    <div class="text-block">
                                        ...
                                        <div class="text"> {{$data3->info_value}}</div>
                                    </div>
                                </div>
                            </div>
