...
<head>
    <meta charset="utf-8">
    <title>Contact Us -Belmaroc</title>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="contact-widget">
                        ...
                        <div class="icon-box">
                            ...
                            <div class="text"><strong>Phone</strong><a href=""></a></div>
                        </div>
                        <div class="icon-box">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fadeInUp animated active" id="tab-two" role="tabpanel" aria-labelledby="tab-two">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="outer-box">
                                    <h4><span class="flaticon-cursor"></span>  {{$data->address}} </h4>
                                    <div class="row">
                                        <div class="col-md-6">
    ...
    <section class="contact-form-section" id="cform">
        <div class="auto-container">
            ...
            <div class="contact-form">
                <form method="post" action=" {{route('add_contact')}} " id="contact-form">
                    @csrf
                    <div class="row">
