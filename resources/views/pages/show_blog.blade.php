...
<head>
    ...
    <link rel="shortcut icon" href="{{'../img/blog/'.$data3->image}} " type="image/x-icon">
    <link rel="icon" href="{{'../img/blog/'.$data3->image}}" type="image/x-icon">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="news-block-four blog-single-post">
                            <div class="inner-box">
                                <div   class="image mb-5"><img style="width:700px" src=" {{'../img/blog/'.$data3->image}} " alt=""></div>
                            ...
                            <div class="widget widget_categories">
                                ...
                                <div class="widget-content">
                                    <ul class="categories-list clearfix">
                                            ...
                                            <li><a href="single-service.php?id="> <i class="flaticon-right-arrow-6"></i> <span></span></a></li>
