...
<title>Login Page  Writers 4</title>
		...
		<div class="card card-login">
			<div class="card-body">
				<div class="row justify-content-center">
					...
					<div class="col-lg-6 col-md-12">
						<div class="padding">
							<h2  style="text-align: center;color: #007bff">Login  Writers</h2>
							
							<p  class="lead">Before you get started, you must login or register if you don't already have
								an account.</p>
							 <form action=" {{route('writer.login_inc_writer')}} " autocomplete="off" method="POST">
                              @if (Session::has('fail'))
