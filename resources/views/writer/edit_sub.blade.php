  ...
  @include('writer.writer_sidbar');
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-8">
            <form action=" {{route('writer.update_sub_user')}} " method="post" enctype="multipart/form-data">
              ...
              <div class="card card-outline card-info">
                ...
                <div class="card-header">
                  {{-- <div class="form-group">
                    <label>type</label>
                    <select name="type" value="{{$data->type}}"class="form-control">
                      <option> 
