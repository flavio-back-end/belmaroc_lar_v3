                    ...
                    <div class="table-responsive mailbox-messages">
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            @foreach ($message as $data)
                                    ...
                                    <td class="mailbox-star"><a href="{{url('message/'.$data->id)}}  "><i class="fas fa-star-o text-warning"></i>{{$data->name}}</a>  </td>
                                    <td class="mailbox-name"><a href=" {{url('message/'.$data->id)}} ">{{$data->email}} </a> </td>
