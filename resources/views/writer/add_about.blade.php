  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-8">
            <form action="{{route('writer.add_about_inc')}} " method="post" enctype="multipart/form-data">
                @csrf
...
@endif
                ...
                <div class="card-header">
                  <div class="form-group">
                    ...
                    <img style="width:200; height:150px;" src="{{url('images/about/')}} ">
                  </div> @error('image')
                  <label style="color: red">{{$message}} </label>
                  @enderror
                </div>
