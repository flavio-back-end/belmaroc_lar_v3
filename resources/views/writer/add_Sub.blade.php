  ...
  @include('writer.writer_sidbar');
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-8">
            <form action=" {{route('writer.add_Sub_user_inc')}} " method="post" enctype="multipart/form-data">
              ...
              <div class="card card-outline card-info">
                ...
                <div class="card-header">
                  <div class="form-group">
                    ...
                    <input name="name" value="" type="text" class="form-control" placeholder="Enter ...">
                  </div>
                  @error('name')
